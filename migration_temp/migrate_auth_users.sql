...
) ON CONFLICT (id) DO UPDATE SET encrypted_password = EXCLUDED.encrypted_password; -- Ensure password updates if exists
...
-- 3. Link Identities (Required for Email Provider login)
INSERT INTO auth.identities (
    id, user_id, identity_data, provider, last_sign_in_at, created_at, updated_at
) VALUES (
    gen_random_uuid(), 'e8e11f7e-2296-405e-b71b-8aff23b94ea7', '{"sub":"e8e11f7e-2296-405e-b71b-8aff23b94ea7", "email": "dra.cintiaborges@gmail.com"}'::jsonb, 'email', now(), now(), now()
) ON CONFLICT DO NOTHING;

INSERT INTO auth.identities (
    id, user_id, identity_data, provider, last_sign_in_at, created_at, updated_at
) VALUES (
    gen_random_uuid(), 'f6611696-dbf0-48c8-86db-e148db7316c3', '{"sub":"f6611696-dbf0-48c8-86db-e148db7316c3", "email": "leonardonettoads@gmail.com"}'::jsonb, 'email', now(), now(), now()
) ON CONFLICT DO NOTHING;
